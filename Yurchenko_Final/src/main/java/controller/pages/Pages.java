...
public interface Pages {
    static final String REGISTRATION_PAGE = "register_page.jsp";
    static final String START_PAGE = "start_page.jsp";
    static final String LOGIN_PAGE = "login_page.jsp";
    static final String CHANGE_PASSWORD_PAGE = "change_password_page.jsp";
